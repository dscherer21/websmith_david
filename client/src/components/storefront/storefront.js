        ...
        <div className='row'>
          ...
          <div className='col-xs-12 col-md-6'>
            <div className='panelPlate'>
              ...
              <a href='https://docs.google.com/document/d/1zS-ldjvxsD6awPmHEeF21TZ_oKm_fLlW1UO5DMhiz4o/edit?usp=sharing' target='_blank'>
        ...
        <div className='row'>
          <div className='col-xs-12'>
            <div className='panelPlate metallicLettering'>
              ...
              <hr/>
              <p>If You would like to view a more traditional webpage layout, please click ==> <a href='https://dscherer21.github.io/bootstrap-portfolio' target='_blank'><strong>HERE</strong></a>.</p>
            </div>
          </div>
        </div>
        <SocialForums/>
