          ...
          <div className='col-xs-12'>
            <div className='panelPlate'>
              ...
              <div className='row'>
                ...
                {/*Stack Overflow*/}
                <div className='col-xs-3'>
                  <a href='https://stackoverflow.com/users/8153526/david-scherer-odell' target='_blank' rel="noopener noreferrer">
                    <img className='img img-thumbnail quote' src='./images/stackoverflowicon.png' alt='Stack Overflow Icon'/>
                  </a>
                </div>
                {/*LinkedIn*/}
                <div className='col-xs-3'>
                  <a href='https://www.linkedin.com/in/david-scherer-odell-9b435850/' target='_blank' rel="noopener noreferrer">
